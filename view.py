...
from widgets import DragDropBttn

from util import RadioController, ItemListLoader, FileOperations, DragDropController
...
class MainCalc(QDialog):
    ...
    def list_init(self) -> QVBoxLayout:
        ...
        item_list_loader = ItemListLoader(self.routes_list)
        self.routes_list.currentItemChanged.connect(item_list_loader.list_load())
    ...
    def freq_init(self) -> QVBoxLayout:
        ...
        radio_controller = RadioController(radio_list)

        self.freq_radio_1.toggled.connect(radio_controller.change_active_1())
        self.freq_radio_2.toggled.connect(radio_controller.change_active_2())
        self.freq_radio_3.toggled.connect(radio_controller.change_active_3())
        self.freq_radio_4.toggled.connect(radio_controller.change_active_4())

        self.other_radio = QRadioButton(self)
        self.freq_other = QLineEdit()
